...
public final class DoorCloseCommand implements ControllerCommand {
	...
	/**
     * Default constructor
     * Uses package visibility to restrict creation of the DoorCloseCommand class.
     */
	DoorCloseCommand(MessagePacket packet, HouseMateModelService service){
	...
	public void execute() {
		...
		try{
			...
			System.out.println("Setting door status Close to: " + doorIdentifier);
			modelService.setApplianceStatus(auth_token, doorIdentifier, "doorStatus", "Closed", "");

...
public class LightOnCommand implements ControllerCommand {
	...
	/**
     * Default constructor
     * Uses package visibility to restrict creation of the LightOnCommand class.
     */
	LightOnCommand(MessagePacket packet, HouseMateModelService service){

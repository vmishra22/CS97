...
public class ResourceRoleAlreadyExistsException extends Exception {
	private String filename;
    private int lineNumber;
    private String description;
    private String commandContext;
	public ResourceRoleAlreadyExistsException() {
		super();
	}
	...
	public String toString() {
		return "ResourceRoleAlreadyExistsException [filename=" + filename + ", lineNumber=" + lineNumber

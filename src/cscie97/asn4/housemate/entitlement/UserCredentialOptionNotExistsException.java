...
public class UserCredentialOptionNotExistsException extends Exception {
	private String filename;
    private int lineNumber;
    private String description;
    private String commandContext;
	public UserCredentialOptionNotExistsException() {
		super();
	}
	...
	public String toString() {
		return "UserCredentialOptionNotExistsException [filename=" + filename + ", lineNumber=" + lineNumber
